...
//declare components for the window one 
void Window::drawWindowOne() {
	//Window 1
...
//declare components for the window two
void Window::drawWindowTwo() {
	//Window 2
	glColor3f(0.6f, 0.7333f, 1.0f);
	glBegin(GL_QUADS);
	glVertex3f(-9.99f, 2.0f, -6.0f);
...
//declare components for the window apron
void Window::drawWindowApron() {
	glColor3f(0.149f, 0.149f, 0.149f);
	glBegin(GL_QUADS);
	glVertex3f(-9.99f, 2.0f, -6.0f);
	glVertex3f(-9.99f, 2.0f, -2.0f);
